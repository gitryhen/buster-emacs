...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (sqlite3 org-roam pomodoro esup vs-light-theme magit auctex flycheck smartparens paredit ac-slime ess evil evil-surround slime slime-company elpy company ido-vertical-mode)))
 '(show-paren-mode t))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
